...
public class Calculadora extends javax.swing.JFrame {
    ...
    public void concatenarNumero (String digito)
    {
        ...
        if (! OperandoActual.isSelected()) 
         operando = (double)Integer.parseInt(OperandoUno.getText());           
        else
            operando = (double)Integer.parseInt(OperandoDos.getText());
        // agréguele la unidad correspondiente al boton que se presionó
        Double resultado = operando * 10 + (double)Integer.parseInt(digito);
    ...
    private void CalcularResultado(String operandoUno, 
        ...
        double intOperandoUno = Double.parseDouble(operandoUno);
        double intOperandoDos = Double.parseDouble(operandoDos);
        double resultado = 0;
        if ("+".equals(operador))
        ...
        if ("*".equals(operador))
            resultado = intOperandoUno * intOperandoDos;
        if ("/".equals(operador)) // division entre cero se realiza una condicion if para poder limitar la division entre cero.
            if(intOperandoDos != 0){
                resultado = intOperandoUno / intOperandoDos; 
            }
            else{
        ...
        String strRestado = String.valueOf(resultado);
        Resultado.setText(strRestado);
    }
}
